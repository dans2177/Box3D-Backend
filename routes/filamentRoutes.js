...
router.put( "/:filamentId/subtraction/:subtractionId", filamentController.updateSubtraction);
router.delete("/:filamentId/subtraction/:subtractionId",filamentController.deleteSubtraction);
router.get("/:filamentId/subtraction/:subtractionId",filamentController.getSubtractions);
